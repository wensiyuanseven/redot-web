...
export default function Circles({ stopColor }) {
    ...
    <svg viewBox="0 0 839 601" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id="paint0_linear_7116_27007" x1="419.501" y1="-119.141" x2="419.501" y2="719.861" gradientUnits="userSpaceOnUse">
          <stop stopColor={stopColor || theme.palette.grey[400]} stopOpacity="0" />
          <stop offset="0.495" stopColor={stopColor || theme.palette.grey[400]} />
          <stop offset="1" stopColor={stopColor || theme.palette.grey[400]} stopOpacity="0" />
        </linearGradient>
